...
public class NetflowDBWritable implements Writable, DBWritable{
   ...
   public NetflowDBWritable(int router, int drection, int timestamp, int type, int flows, int packets, int bytes) {  
	   this.router = router;
